...
export default function Questions() {
  const { questions, setQuestions, showScore, setShowScore, Notanswered, setNotAnswered,user,setRefreshProfile,category,triggerRefresh} = useQuestions();
...
if(quizSubmitted){
  ...
  if(questions === null || questions.length === 0){
    fetch("http://localhost:8080/question/category/javascript")
    .then((res)=>res.json())
